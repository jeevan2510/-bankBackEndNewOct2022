    ...
    return db.User.findOne({
        ...
        (result) => {
            if (result) {
                ...
                return {
                    statusCode: 404,
                    message: 'invlid account/password'
                }
            }
        }
    )
...
const fundTransfer = (req, toAcno, pswd, amt) => {
    ...
    return db.User.findOne({
        ...
        if (fromAcno == toAcno) {
            return {
                statusCode: 401,
                message: "Can't tranfer own Account"
            }
        }
        if (result) {
            ...
            if (fromAcnoBalance >= amount) {
                ...
                return db.User.findOne({
                    ...
                    if (creditdata) {
                        ...
                        return {
                            statusCode: 200,
                            message: "Amount transfer sucessully"
                        }
                    } else {
                        return {
                            statusCode: 401,
        ...
        .then(
            (result) => {
                if (result) {
                    return {
                        statusCode: 200,
                        message: "Account Deleted Successfullyt"
                    }
                }
                else {
                    return {
